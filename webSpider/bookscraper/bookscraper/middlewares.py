...
class FakeBrowserHeader:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoint = settings.get("SCRAPEOPS_FAKE_BROWSER_HEADER_ENDPOINT", "https://headers.scrapeops.io/v1/browser-headers") #https://headers.scrapeops.io/v1/user-agents?api_key=91aabba2-ceea-4004-8198-b8cbddbe07e9
    ...
    def _scrapeops_fake_browser_headers_enabled(self):
        if  (self.scrapeops_api_key is None) or (self.scrapeops_api_key == ""):
            self.scrapeops_scrapeops_fake_browser_headers_active = False
        else:
            self.scrapeops_scrapeops_fake_browser_headers_active = True
